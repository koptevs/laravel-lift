...
5.2 Palielināta lifta pretsvara brīvkustība vadotnēs (vādkurpju ieliktņi ir nolietoti).',
    ...
    function index()
    {
        ...
        $valditajs = [
            'valditajs_nosaukums'    => 'SIA "Rīgas namu pārvaldnieks"',
            'valditajs_adrese'        => 'Aleksandra Čaka iela 42, Rīga, LV-1011',
            'valditajs_reg_nr'        => '40103362321',
            'valditajs_liguma_nr'     => '6-15/1159',
            'valditajs_liguma_datums' => '21.04.2020',
        ];
...
////////////////////////////////////////////////////////////////////
        ...
        left_padding();
        $pdf->setFillColor(128, 128, 255);
        $pdf->cell(0, 11, "LIFTA TEHNISKĀS PĀRBAUDES PROTOKOLS Nr. ".$parbaude['parbaude_nr'], 0, 1, 'C', false);
...
////////////////////////////////////////////////////////////////////
        ...
        $pdf->cell( $parbaudes_veids_3col_width, $parbaudes_veids_cell_height, $parbaude['parbaude_veids'] === 'pirmreizējā' ? 'X' : '', 1, 0, 'C', false );
        $pdf->SetFont( $parbaudes_veids_font_family, '', $parbaudes_veids_font_size );
        $pdf->cell( $parbaudes_veids_4col_width, $parbaudes_veids_cell_height, "Kārtējā", 0, 0, 'C', false );
        $pdf->SetFont( $parbaudes_veids_mark_font_family, '', $parbaudes_veids_mark_font_size );
        $pdf->cell( $parbaudes_veids_5col_width, $parbaudes_veids_cell_height, $parbaude['parbaude_veids'] === 'kārtējā' ? 'X' : '', 1, 0, 'C', false );
        $pdf->SetFont( $parbaudes_veids_font_family, '', $parbaudes_veids_font_size );
        $pdf->cell( $parbaudes_veids_6col_width, $parbaudes_veids_cell_height, "Ārpuskārtas", 0, 0, 'C', false );
        $pdf->SetFont( $parbaudes_veids_mark_font_family, '', $parbaudes_veids_mark_font_size );
        $pdf->cell( $parbaudes_veids_7col_width, $parbaudes_veids_cell_height, $parbaude['parbaude_veids'] === 'ārpuskārtas' ? 'X' : '', 1, 0, 'C', false );
        $pdf->SetFont( $parbaudes_veids_font_family, '', $parbaudes_veids_font_size );
        $pdf->cell( $parbaudes_veids_8col_width, $parbaudes_veids_cell_height, "Atkārtotā", 0, 0, 'C', false );
        $pdf->SetFont( $parbaudes_veids_mark_font_family, '', $parbaudes_veids_mark_font_size );
        $pdf->cell( $parbaudes_veids_9col_width, $parbaudes_veids_cell_height, $parbaude['parbaude_veids'] === 'atkārtotā' ? 'X' : '', 1, 1, 'C', false );
...
////////////////////////////////////////////////////////////////////
        ...
        $pdf->SetFont( $zinas_par_label_font_family, '', $zinas_par_label_font_size );
        $pdf->cell( $zinas_par_uzstaditajs_cell_width, $zinas_par_cell_height, $lifts['lifts_uzstaditajs'], "B", 1, 'C', false );
...
////////////////////////////////////////////////////////////////////
        ...
        $pdf->SetFont( $lifta_tips_label_font_family, '', $lifta_tips_label_font_size );
        $pdf->cell( $lifta_tips_mark_cell_width, $lifta_tips_cell_height, $lifts['lifts_tips'] === 'elektriskais' ? 'X' : '', 1, 0, 'C', false );

        $pdf->SetFont( $lifta_tips_font_family, '', $lifta_tips_font_size );
        $pdf->cell( $lifta_tips_cell_width, $lifta_tips_cell_height, "hidrauliskais ", 0, 0, 'R', false );
        $pdf->SetFont( $lifta_tips_label_font_family, '', $lifta_tips_label_font_size );
        $pdf->cell( $lifta_tips_mark_cell_width, $lifta_tips_cell_height, $lifts['lifts_tips'] === 'hidrauliskais' ? 'X' : '', 1, 1, 'C', false );
...
// parbaudes rezultati 1 row start
        ...
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["4.1"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["4.1"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["4.1"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
...
// parbaudes rezultati 3 row start
        ...
        $pdf->SetFont( $font_family_default_bold, '', $parbaudes_rezultati_label_font_size );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["1.3"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["1.3"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        ...
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["4.3"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["4.3"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 1, 'C', false );
...
// parbaudes rezultati 4 row start
        ...
        $pdf->SetFont( $font_family_default_bold, '', $parbaudes_rezultati_label_font_size );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["1.4"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["1.4"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
...
// parbaudes rezultati 5 row start
        ...
        $pdf->SetFont( $font_family_default_bold, '', $parbaudes_rezultati_label_font_size );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["5.1"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["5.1"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 1, 'C', false );
...
// parbaudes rezultati 6 row start
        ...
        $pdf->SetFont( $font_family_default_bold, '', $parbaudes_rezultati_label_font_size );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["2.1"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["2.1"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        ...
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["5.2"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["5.2"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 1, 'C', false );
...
// parbaudes rezultati 7 row start
        ...
        $pdf->SetFont( $font_family_default_bold, '', $parbaudes_rezultati_label_font_size );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["2.2"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["2.2"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        ...
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["5.3"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["5.3"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 1, 'C', false );
...
// parbaudes rezultati $parbaudes_rezultati_text_font_size row start
        ...
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["5.4"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["5.4"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 1, 'C', false );
...
// parbaudes rezultati 9 row start
        ...
        $pdf->SetFont( $font_family_default_bold, '', $parbaudes_rezultati_label_font_size );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["3.1"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["3.1"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        ...
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["5.5"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["5.5"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 1, 'C', false );
...
// parbaudes rezultati 10 row start
        ...
        $pdf->SetFont( $font_family_default_bold, '', $parbaudes_rezultati_label_font_size );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["3.2"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["3.2"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
...
// parbaudes rezultati 12 row start
        ...
        $pdf->SetFont( $font_family_default_bold, '', $parbaudes_rezultati_label_font_size );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["3.4"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["3.4"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
...
// parbaudes rezultati 13 row start
        ...
        $pdf->SetFont( $font_family_default_bold, '', $parbaudes_rezultati_label_font_size );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["3.5"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["3.5"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
...
// parbaudes rezultati 14 row start
        ...
        $pdf->SetFont( $font_family_default_bold, '', $parbaudes_rezultati_label_font_size );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["3.6"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["3.6"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        ...
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["7.1"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["7.1"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 1, 'C', false );
...
// parbaudes rezultati 15 row start
        ...
        $pdf->SetFont( $font_family_default_bold, '', $parbaudes_rezultati_label_font_size );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["3.7"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["3.7"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        ...
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["7.2"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["7.2"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 1, 'C', false );
...
// parbaudes rezultati 16 row start
        ...
        $pdf->SetFont( $font_family_default_bold, '', $parbaudes_rezultati_label_font_size );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["3.8"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["3.8"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        ...
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["8.0"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["8.0"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 1, 'C', false );
...
// parbaudes rezultati 17 row start
        ...
        $pdf->SetFont( $font_family_default_bold, '', $parbaudes_rezultati_label_font_size );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["3.9"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["3.9"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        ...
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, isset( $prp["9.0"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, ! isset( $prp["9.0"] ) || $is_blank ? "" : "X", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 0, 'C', false );
        $pdf->cell( $parbaudes_rezultati_mark_column_width, $parbaudes_rezultati_cell_height, "", 1, 1, 'C', false );
...
////////////////////////////////////////////////////////////////////////////////
        ...
        $pdf->cell( $derigs_ekspluatacijai_1col_width, $derigs_ekspluatacijai_cell_height, count( $prp ) || $is_blank ? '' : 'X', 1, 0, 'C', false );
        ...
        $pdf->SetFont( $derigs_ekspluatacijai_mark_font_family, '', $derigs_ekspluatacijai_mark_font_size );
        $pdf->cell( $derigs_ekspluatacijai_3col_width, $derigs_ekspluatacijai_cell_height, ! count( $prp ) || $is_blank ? '' : 'X', 1, 0, 'C', false );
...
//$pdf->cell( $nakosa_parbaude_2col_width, 5, $parbaude['parbaude_datums'], "B", 0, 'C', false );
        $pdf->cell( $nakosa_parbaude_2col_width, 5, $parbaude['parbaude_datums'] ? date_format( date_add( date_create_from_format( 'j.n.Y', $parbaude['parbaude_datums'] ), date_interval_create_from_date_string( '1 year' ) ), 'd.m.Y' ) : '', "B", 0, 'C', false );
...
////////////////////////////////////////////////////////////////////////////////
        ...
        $pdf->cell( $parbaude_piedalijas_1col_width, 5, $parbaude['parbaude_mehanika_kompanija'] ? $parbaude['parbaude_mehanika_kompanija'] . ' mehāniķis' : '', "B", 0, 'L', false );
//$pdf->cell( $parbaude_piedalijas_1col_width, 5, "", "B", 0, 'L', false );
        $pdf->SetFont( $font_family_default_bold, '', $font_size_default );
//$pdf->cell( $parbaude_piedalijas_2col_width, 5, "", "B", 0, 'R', false );
        $pdf->cell( $parbaude_piedalijas_2col_width, 5, $parbaude['parbaude_mehanikis_vards_uzvards'], "B", 0, 'R', false );
        $pdf->SetFont( $font_family_default_bold, '', $font_size_default );
...
// footer
        $pdf->Ln( 50 );
        left_padding();
        $pdf->cell( 0, 7, "Protokols parakstīts ar drošu elektronisko parakstu un satur laika zīmogu.", 0, 0, 'L', false );
...
//getPositionForCheckbox($pdf); //place where checkbox is needed
        ...
        foreach ( $empty_checkboxes as $empty_checkbox){
            $pdf->Image( './img/checkbox.png', $empty_checkbox['x'] + $el_merijumi_second_table_col_data_width / 2 - $checkbox_image_width / 2, $empty_checkbox['y'], $checkbox_image_width, $checkbox_image_height, );
        }
// var_dump($checkboxes);


// var_dump($parbaude);
        $pdf->output( 'I', $parbaude['parbaude_datums']. '_' . $lifts['lifts_reg_nr'] . '_' . str_replace( ',', '_', $lifts['lifts_parbaudes_adrese'] ) . '.pdf', true );
